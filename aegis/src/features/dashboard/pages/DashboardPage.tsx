...
export function DashboardPage() {
    ...
    // Live deltas from realtime monitoring store
    ...
    const STATS = [
        ...
        {
            // Blend DB total_warnings with live realtime flags from current session
            label: 'Flags Raised',
            value: stats.totalWarnings + totalFlags,
    ...
    return (
        <div className="space-y-6 max-w-7xl">
            ...
            {/* Stats grid — Flags Raised updates live during an active session */}
            ...
            {/* High-severity alert banner — appears when realtime events are critical */}
            {highSeverityCount > 0 && (
                <motion.div
