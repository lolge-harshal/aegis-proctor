                                ...
                                {participants.map((p, i) => (
                                    ...
                                    >
                                        <div className="flex items-center justify-between">
                                            ...
                                            <Badge variant={p.status === 'active' ? 'emerald' : p.status === 'flagged' ? 'rose' : 'slate'}>
                                                {p.status}
                                            </Badge>
                                        </div>
                                        ...
                                        <div className="space-y-1">
                                            <div className="flex justify-between text-xs">
                                                ...
                                                <span className={p.riskScore > 70 ? 'text-rose-400' : p.riskScore > 40 ? 'text-amber-400' : 'text-emerald-400'}>
                                                    {p.riskScore}%
                                                </span>
                                            </div>
                                            <div className="h-1.5 bg-[#2a2a3a] rounded-full overflow-hidden">
                                                <motion.div
                                                    ...
                                                    className={cn('h-full rounded-full', p.riskScore > 70 ? 'bg-rose-500' : p.riskScore > 40 ? 'bg-amber-500' : 'bg-emerald-500')}
                                                />
                                            </div>
                                        </div>
